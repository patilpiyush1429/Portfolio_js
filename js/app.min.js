...
// Handling Z-Index for Overlapping Elements (Unchanged)
...
// Function to Get Mouse or Touch Event
...
// Start Dragging (Only for Modals)
function touchstart(e) {
  var touchEvt = getTouchEvent(e);
  dragEl = null;

  // Only allow dragging for modals, NOT for cards
  if (e.target.closest(".modal-header")) {
    dragEl = e.target.closest(".modal");

    // Store initial mouse/touch position
    startX = touchEvt.clientX;
    startY = touchEvt.clientY;
    
    // Calculate the difference between cursor and modal position
    differenceX = startX - dragEl.offsetLeft;
    differenceY = startY - dragEl.offsetTop;
  }
}

// Drag Movement (Only for Modals)
